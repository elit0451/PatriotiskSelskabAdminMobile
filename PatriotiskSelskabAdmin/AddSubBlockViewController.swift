//
//  AddSubBlockViewController.swift
...
class AddSubBlockViewController: UIPageViewController, UIPageViewControllerDataSource {
    
    var passedSubBlockObj = SubBlock()
    
    lazy var viewControllerList:[UIViewController] = {
        let storyBoard = UIStoryboard(name: "Main", bundle: nil)
        
        let viewInfo = storyBoard.instantiateViewController(withIdentifier: "AddSubBlockInfo")
        let viewSubBlocks = storyBoard.instantiateViewController(withIdentifier: "AddSubBlockTrialGroups")
    ...
    override func viewDidLoad() {
        ...
        if let secondViewController = viewControllerList.last as? AddSubBlockTrialGroupsViewController{
            secondViewController.addedSubBlock = self.passedSubBlockObj
        }
        
        if let firstViewController = viewControllerList.first as? AddSubBlockInfoViewController{
            firstViewController.addedSubBlock = self.passedSubBlockObj
